...
struct SvgDrawer {
	...
	std::string toStr(Coord viewBoxMinX, Coord viewBoxMinY, Coord viewBoxWidth, Coord viewBoxHeight,
		...
		std::string style = "<style>rect { fill:grey; stroke:black; stroke-width: 1px; } line { stroke:black; stroke-width: 0.01px; } path { stroke: black; fill:transparent; }</style>") const {
